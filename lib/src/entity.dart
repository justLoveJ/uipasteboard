...
class _UIPasteboardImpl implements UIPasteboard {
  ...
  Future<bool> hasColor() async {
    return await _channel.invokeMethod<bool>("hasColor") ?? false;
  }
  ...
  Future<bool> hasString() async {
    return await _channel.invokeMethod<bool>("hasString") ?? false;
  }
